...
#if UNITY_3_5
[CustomEditor(typeof(UI2DButton))]
#else
[CustomEditor(typeof(UI2DButton), true)]
#endif
public class UI2DButtonEditor : UIButtonColorEditor
{
	enum Highlight
	{
		DoNothing,
	...
	protected override void DrawProperties ()
	{
		...
		UI2DButton btn = target as UI2DButton;
		...
		UI2DButton button = target as UI2DButton;
